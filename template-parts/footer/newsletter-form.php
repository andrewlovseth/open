<div class="newsletter-form">
    ...
    <style>
        ...
        #_form_7_ input[type="text"],#_form_7_ input[type="tel"],#_form_7_ input[type="date"],#_form_7_ textarea { padding: 8px 16px; height:auto; border:#979797 1px solid; border-radius:4px; color:#000 !important; font-size:14px; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box; }
        ...
        #_form_7_ ._form_element { position:relative; font-size:0; max-width:100%; }
        #_form_7_ ._form_element * { font-size:14px; }
        #_form_7_ ._form_element._clear { clear:both; width:100%; float:none; }
        #_form_7_ ._form_element._clear:after { clear:left; }
        #_form_7_ ._form_element input[type="text"],#_form_7_ ._form_element input[type="date"],#_form_7_ ._form_element select,#_form_7_ ._form_element textarea:not(.g-recaptcha-response) { display:block; width:100%; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box; font-family:inherit; border: none; border-radius: 0; }
        ...
        @media all and (min-width:320px) and (max-width:667px) { ::-webkit-scrollbar { display:none; }
            ...
            #_form_7_ ._form_element { margin:0; width:100%; }
            ...
            #_form_7_ { position:relative; text-align:left; padding:2rem; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box; *zoom:1; background:transparent !important; border:0px solid #b0b0b0 !important; -moz-border-radius:0px !important; -webkit-border-radius:0px !important; border-radius:0px !important; color:#fff !important; 
        ...
        #_form_7_._inline-style input[type="text"],#_form_7_._inline-style input[type="date"] { padding:8px 16px; }
    ...
    <link rel="stylesheet" type="text/css" href="https://unpkg.com/intl-tel-input@17.0.18/build/css/intlTelInput.min.css"/>
        <form method="POST" action="https://opendrives.activehosted.com/proc.php" id="_form_7_" class="_form _form_7 _inline-form  _dark" novalidate>
        ...
        <input type="hidden" name="or" value="99b827de570208881c35dcb54ca828d5" />
        <div class="_form-content">
            ...
            <div class="field-container">
                ...
                <div class="_button-wrapper _full_width cta">
                    <button id="_form_7_submit" class="_submit btn white-outline" type="submit">
                        Sign Up
                    </button>
                </div>
            </div>
...
(function() {
  ...
  var form_submit = function(e) {
    ...
    if (validate_form()) {
      ...
      _load_script('https://opendrives.activehosted.com/proc.php?' + serialized + '&jsonp=true');
    }
    return false;
  };
