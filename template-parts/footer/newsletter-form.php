...
<form method="POST" action="https://opendrives.activehosted.com/proc.php" id="_form_7_" class="_form _form_7 _inline-form  _dark" novalidate data-styles-version="3">
  ...
  <div class="_form-content">
    ...
    <div class="_form_element _x59704903 _full_width " >
      <div class="g-recaptcha" data-theme="dark" data-sitekey="6LcwIw8TAAAAACP1ysM08EhCgzd6q5JAOUR1a0Go">
      </div>
    </div>
    ...
    var form_submit = function(e) {
        ...
        if (validate_form()) {
            ...
            async function submitForm() {
              ...
              const response = await fetch('https://opendrives.activehosted.com/proc.php?jsonp=true', {
                headers: {
